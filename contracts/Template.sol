...
contract Template is TemplateBase {
    ...
    function newInstance() public {
        ...
        bytes32 rDaiAdminAppId = apmNamehash("rdai");
        ...
        RDaiAdmin rDaiAdminApp = RDaiAdmin(dao.newAppInstance(rDaiAdminAppId, latestVersionAppBase(rDaiAdminAppId)));
        ...
        agent.initialize();
        //
        rDaiAdminApp.initialize(address(agent), address(voting), address(token)); //set this to rdai deployed token address
